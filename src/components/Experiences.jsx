...
import { Dropdown, Card, Image, CardContent, Header, Container, Segment, Grid } from 'semantic-ui-react'
...
const handleClick = (e) => {
  ...
  <Container style={{backgroundColor:"#f4efee", opacity:".8", marginTop:"5em" }}  >
    <Grid.Row>
    ...
    <Dropdown.Menu>
      ...
      <Dropdown.Item className='drop' text='disney' icon="fort awesome icon" onClick={handleClick}/>
